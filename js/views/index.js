PersonalPages.Views.Index = Backbone.View.extend({
	...
	/* Portfolio */ "<div id='portfolio' class='portfolio-wrapper group'><section class='portfolio group'><div class='github-wrapper'><a class='fontawesome github group' href='http://www.github.com/gmmeyer'><i class='fa fa-github-alt fa-5x group'></i><p class='group'>The code for everything in my portfolio is up on my github, you can reach them through the links below, or you can go directly to my github, here.</p></a></div><!-- <a class='fontawesome group' href='#code'><i class='fa fa-code fa-5x'></i></a> --><section class='group portfolio-items'>" + 
		/*Rap Kinda Smart*/ "<article class='group portfolio-item'><a class='slider'><h2>RapKindaSmart</h2><img src='images/rapkindasmart.png' height='300px' width='600px'></a><article class='slidee isHidden'><p><a href='http://rapkindasmart.com'>deployed</a></p><p><a href='http://github.com/gmmeyer/codekindasmart'>source</a></p><p>Rap Kinda Smart is a clone of the website <a href='http://rapgenius.com'>Rap Genius</a>. It allows users to upload and annotate static text. It has algorithms that allow annotations to be displayed properly on static text. The code utilizes polymorphic association to give notifications to users regarding content they care about. And, it also utilizes a cron function to rank content that users vote on--the voting functionality utilizes single table inheritance.</p></article></article>" + 
	...
	/*Contact Section*/ "<div id='contact' class='contact-wrapper'><section id='contact' class='contact group'><a class='fontawesome' href='mailto:gregory.matthew.meyer@gmail.com?subject=Hey%20Greg!'><i class='fa fa-envelope-o fa-5x'></i></a><a class='fontawesome' href='http://www.linkedin.com/pub/gregory-meyer/37/864/702/'><i class='fa fa-linkedin fa-5x'></i></a><a class='fontawesome' id='phone'><i class='fa fa-phone fa-5x'></i></a><p class='slidee isHidden' id='phone'> 862 684 9101</p><a class='fontawesome' id='skype'><i class='fa fa-skype fa-5x'></i></a><p class='slidee isHidden' id='skype'>flubbishone</p></section></div>"),
